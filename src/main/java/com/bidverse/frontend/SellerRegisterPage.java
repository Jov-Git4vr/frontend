 ...
 */
public class SellerRegisterPage extends JPanel {
    ...
    public SellerRegisterPage(MainFrame navigator) {
        ...
        JLabel title = new JLabel("Seller Registration", SwingConstants.CENTER);
        ...
        shopField.setBorder(BorderFactory.createTitledBorder("Shop name"));
        shopField.setBounds(60, 320, 360, 40);
        bg.add(shopField);

        addressField.setBorder(BorderFactory.createTitledBorder("Address"));
        addressField.setBounds(60, 380, 360, 40);
        bg.add(addressField);

        JButton registerBtn = new JButton("Register");
        registerBtn.setBounds(60, 440, 360, 44);
        ...
        backBtn.setBounds(60, 500, 360, 40);
    ...
    private void onRegister() {
        ...
        if (ok) {
            ...
            JOptionPane.showMessageDialog(this, "Seller registered successfully. Please log in.", "Success",
